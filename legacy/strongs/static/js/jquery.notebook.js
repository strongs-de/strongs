	...
	var o,
		a = (function () {
			var e = function (e) {
				...
				o = function (e, t) {
					(e.css('-webkit-transform', t),
						e.css('-moz-transform', t),
						e.css('-o-transform', t),
						e.css('-ms-transform', t),
						e.css('transform', t));
				},
				a = function (e) {
					return (
				...
				i = function (e) {
					var t = n(e);
					return { x: parseInt(t[4]), y: parseInt(t[5]) };
				},
				l = function (e, t) {
					var i = n(e);
					i[0] = i[3] = t;
			...
			return { scale: l, translate: c, rotate: r, getTranslate: i };
		})(),
		i = 'MacIntel' == n.navigator.platform,
		l = 0,
		c = 0,
		r = { command: !1, shift: !1, isSelecting: !1 },
		s = { 66: 'bold', 73: 'italic', 85: 'underline', 112: 'h1', 113: 'h2', 122: 'undo' },
		d = {
			keyboard: {
			...
			html: {
				addTag: function (n, o, a, i) {
					...
					return (
						l.attr('contenteditable', Boolean(i)),
						l.append(' '),
						n.append(l),
						a && ((r.focusedElement = n.children().last()), d.cursor.set(n, 0, r.focusedElement)),
						l
					);
				}
			},
			cursor: {
				set: function (e, o, a) {
					...
					if (t.createRange) {
						...
						((i = t.body.createTextRange()), i.moveToElementText(a), i.collapse(!1), i.select());
				}
			},
			selection: {
				save: function () {
				...
				getText: function () {
					...
					return (
						n.getSelection
							? (e = n.getSelection().toString())
							: t.getSelection
								? (e = t.getSelection().toString())
								: t.selection && (e = t.selection.createRange().text),
						e
					);
				},
				clear: function () {
				...
				getContainer: function (e) {
					return n.getSelection && e && e.commonAncestorContainer
						? e.commonAncestorContainer
						: t.selection && e && e.parentElement
							? e.parentElement()
							: null;
				},
				getSelection: function () {
					return n.getSelection
						? n.getSelection()
						: t.selection && t.selection.createRange
							? t.selection
							: null;
				}
			},
		...
		u = {
			updatePos: function (t, o) {
				var i = n.getSelection(),
					...
					d =
						(t.offset().left,
						{ x: c.left + c.width / 2 - r / 2, y: c.top - s - 8 + e(document).scrollTop() });
			...
			checkForFormatting: function (e, t) {
				...
				('#text' === e.nodeName || -1 != n.indexOf(e.nodeName.toLowerCase())) &&
					('#text' != e.nodeName && t.push(e.nodeName.toLowerCase()),
					u.checkForFormatting(e.parentNode, t));
			},
			...
			show: function () {
				...
				(t.length ||
					((t = d.html.addTag(e(this).parent(), 'div', !1, !1)),
					t.addClass('jquery-notebook bubble')),
					t.empty(),
					u.buildMenu(this, t),
					t.show(),
					u.updateState(this, t),
					t.hasClass('active') ? t.removeClass('jump') : t.addClass('jump'),
					u.updatePos(e(this), t),
					t.addClass('active'));
			},
			update: function () {
				var t = e(this).parent().find('.bubble');
			...
			clear: function () {
				...
				t.hasClass('active') &&
					...
					u.hideLinkInput.call(this),
					u.showButtons.call(this),
					setTimeout(function () {
			...
			showLinkInput: function (t) {
				...
				(o.unbind('keydown'),
					o.keydown(function (o) {
						...
						d.keyboard.isEnter(o, function () {
							o.preventDefault();
							var e = i.val();
							d.validation.isUrl(e)
								? ((o.url = e), m.commands.createLink(o, t), u.clear.call(n))
								: '' === e && a && (m.commands.removeLink(o, t), u.clear.call(n));
						});
					}),
				...
				(e(this).parent().find('.link-area').show(), o.val(i).focus());
			},
		...
		h = {
			bindEvents: function (t) {
				(t.keydown(f.keydown),
					t.keyup(f.keyup),
					t.focus(f.focus),
					t.bind('paste', m.paste),
					t.mousedown(f.mouseClick),
					t.mouseup(f.mouseUp),
					t.mousemove(f.mouseMove),
					t.blur(f.blur),
					e('body').mouseup(function (e) {
			...
			setPlaceholder: function (t) {
				if (/^\s*$/.test(e(this).text())) {
					...
					(n.append(e(this).attr('editor-placeholder')),
						d.html.addTag(e(this), 'p', 'undefined' != typeof t.focus ? t.focus : !1, !0));
			...
			setContentArea: function (t) {
				...
				var o = e('body');
				((contentArea = e('<textarea></textarea>')),
					contentArea.css({ position: 'absolute', left: -1e3 }),
					contentArea.attr('id', 'jquery-notebook-content-' + n),
					o.append(contentArea));
			},
			prepare: function (e, t) {
				if (
					((o = t),
					h.setContentArea(e),
					e.attr('editor-mode', o.mode),
					e.attr('editor-placeholder', o.placeholder),
					e.attr('contenteditable', !0),
					e.css('position', 'relative'),
					e.addClass('jquery-notebook editor'),
					h.setPlaceholder.call(e, {}),
					h.preserveElementFocus.call(e),
					o.autoFocus === !0)
				) {
		...
		f = {
			keydown: function (e) {
				...
				(r.command &&
					...
					13 === e.which && m.enterKey.call(this, e),
					27 === e.which && u.clear.call(this),
					86 === e.which && r.command && m.paste.call(this, e),
					90 === e.which && r.command && m.commands.undo.call(this, e));
			},
			keyup: function (t) {
				(d.keyboard.isCommand(
					t,
					...
					h.preserveElementFocus.call(this),
					h.removePlaceholder.call(this),
					/^\s*$/.test(e(this).text()) && (e(this).empty(), d.html.addTag(e(this), 'p', !0, !0)),
					m.change.call(this));
			},
			focus: function () {
			...
			blur: function () {
				h.setPlaceholder.call(this, { focus: !1 });
			}
		},
		m = {
			commands: {
				...
				italic: function (e) {
					(e.preventDefault(),
						t.execCommand('italic', !1),
						u.update.call(this),
						m.change.call(this));
				},
				underline: function (e) {
					(e.preventDefault(),
						t.execCommand('underline', !1),
						u.update.call(this),
						m.change.call(this));
				},
				anchor: function (e) {
				...
				createLink: function (e, n) {
					(d.selection.restore(n),
						t.execCommand('createLink', !1, e.url),
						u.update.call(this),
						m.change.call(this));
				},
				...
				h1: function (n) {
					(n.preventDefault(),
						e(window.getSelection().anchorNode.parentNode).is('h1')
							? t.execCommand('formatBlock', !1, '<p>')
							: t.execCommand('formatBlock', !1, '<h1>'),
						u.update.call(this),
						m.change.call(this));
				},
				h2: function (n) {
					(n.preventDefault(),
						e(window.getSelection().anchorNode.parentNode).is('h2')
							? t.execCommand('formatBlock', !1, '<p>')
							: t.execCommand('formatBlock', !1, '<h2>'),
						u.update.call(this),
						m.change.call(this));
				},
				ul: function (e) {
				...
				ol: function (e) {
					(e.preventDefault(),
						t.execCommand('insertOrderedList', !1),
						u.update.call(this),
						m.change.call(this));
				},
				undo: function (o) {
			...
			enterKey: function (t) {
				if ('inline' === e(this).attr('editor-mode'))
			...
			paste: function () {
				...
				if (a.length < 1) {
					var i = e('body');
					((a = e('<textarea></textarea>')),
						a.css({ position: 'absolute', left: -1e3 }),
						a.attr('id', n),
						i.append(a));
				}
				(a.focus(),
					setTimeout(function () {
						for (var e = '', n = a.val().split('\n'), i = 0; i < n.length; i++)
							e += ['<p>', n[i], '</p>'].join('');
						(a.val(''),
							d.selection.restore(o),
							t.execCommand('delete'),
							t.execCommand('insertHTML', !1, e),
							m.change.call(this));
					}, 500));
			},
			change: function () {
				...
				t.val(e(this).html());
				var n = t.val(),
					o = new CustomEvent('contentChange', { detail: { content: n } });
				this.dispatchEvent(o);
			}
		};
	((e.fn.notebook = function (t) {
		return (
			(t = e.extend({}, e.fn.notebook.defaults, t)),
			h.prepare(this, t),
			h.bindEvents(this),
			this
		);
