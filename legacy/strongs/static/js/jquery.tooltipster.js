					...
					// if the tooltip isn't already open, open that sucker up!
						...
						var animation = 'tooltipster-' + self.options.animation,
							animationSpeed =
								...
								'ms;',
							fixedWidth =
								self.options.fixedWidth > 0
									? 'width:' + Math.round(self.options.fixedWidth) + 'px;'
									: '',
							maxWidth =
								self.options.maxWidth > 0
						...
						if (supportsTransitions()) {
							self.$tooltip
								.css({
									width: '',
									'-webkit-transition':
										'all ' + self.options.speed + 'ms, width 0ms, height 0ms, left 0ms, top 0ms',
									'-moz-transition':
										'all ' + self.options.speed + 'ms, width 0ms, height 0ms, left 0ms, top 0ms',
									'-o-transition':
										'all ' + self.options.speed + 'ms, width 0ms, height 0ms, left 0ms, top 0ms',
		...
		reposition: function () {
			...
			if ($('body').find(self.$tooltip).length !== 0) {
				...
				function dontGoOffScreenY(switchTo, switchFrom) {
					...
					if (
						proxy.offset.top - $(window).scrollTop() - tooltipHeight - offsetY - 12 < 0 &&
					...
					if (
						proxy.offset.top + proxy.dimension.height + tooltipHeight + 12 + offsetY >
				...
				if (practicalPosition == 'top') {
					var leftDifference =
						proxy.offset.left + tooltipWidth - (proxy.offset.left + proxy.dimension.width);
				...
				if (practicalPosition == 'left') {
					...
					var topDifference =
						proxy.offset.top + tooltipHeight - (proxy.offset.top + proxy.dimension.height);
			...
			if (typeof args[0] === 'string') {
				...
				this.each(function () {
					...
					if (self) {
						...
						throw new Error(
							'You called Tooltipster\'s "' + args[0] + '" method on an uninitialized element'
						);
					}
				});
