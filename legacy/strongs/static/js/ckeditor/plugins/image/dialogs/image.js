											...
											children: [
														...
														if (a == f) {
															...
															d =
																(d =
																	...
																	d.match(/^(\d+px)(?: \1 \1 \1)?$/)) && parseInt(d[1], 10);
													...
													commit: function (a, b, c) {
														...
														a == f || 4 == a
															? (isNaN(e)
																	...
																	: (b.setStyle('margin-left', CKEDITOR.tools.cssLength(e)),
																		b.setStyle('margin-right', CKEDITOR.tools.cssLength(e))),
													...
													commit: function (a, b, c) {
														...
														a == f || 4 == a
															? (isNaN(e)
																	...
																	: (b.setStyle('margin-top', CKEDITOR.tools.cssLength(e)),
																		b.setStyle('margin-bottom', CKEDITOR.tools.cssLength(e))),
												...
												},
												{
													...
													commit: function (a, b, c) {
														...
														if (a == f || 4 == a) {
															if (
																(e ? b.setStyle('float', e) : b.removeStyle('float'), !c && a == f)
															)
