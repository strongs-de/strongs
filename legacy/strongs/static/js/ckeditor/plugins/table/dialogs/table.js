				...
				'tableProperties' == e &&
					((g = g.getSelectedElement()) && g.is('table')
						...
						: 0 < d.length &&
							...
							(c = a.elementPath(d[0].getCommonAncestor(!0)).contains('table', 1))),
										...
										if (this.isEnabled()) {
											...
											if (c)
												(0 < b.count()
													...
													: ((b = new CKEDITOR.dom.element('caption', a.document)),
														d.getChildCount() ? b.insertBefore(d.getFirst()) : b.appendTo(d)),
