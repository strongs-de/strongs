/* Tooltipster v3.2.1 */ (function (e, t, n) {
	...
	s.prototype = {
					...
					if (r.Status !== 'hidden') {
						...
						var o = 'tooltipster-' + r.options.animation,
							a =
								...
								'ms;',
							f =
								r.options.fixedWidth > 0 ? 'width:' + Math.round(r.options.fixedWidth) + 'px;' : '',
							c =
								r.options.maxWidth > 0 ? 'max-width:' + Math.round(r.options.maxWidth) + 'px;' : '',
						...
						if (l()) {
							t.$tooltip
								.css({
									width: '',
									'-webkit-transition':
										'all ' + t.options.speed + 'ms, width 0ms, height 0ms, left 0ms, top 0ms',
									'-moz-transition':
										'all ' + t.options.speed + 'ms, width 0ms, height 0ms, left 0ms, top 0ms',
									'-o-transition':
										'all ' + t.options.speed + 'ms, width 0ms, height 0ms, left 0ms, top 0ms',
		...
		reposition: function () {
			...
			if (e('body').find(n.$tooltip).length !== 0) {
				...
				function B(n, r) {
					...
					if (
						s.offset.top + s.dimension.height + a + 12 + _ > e(t).scrollTop() + e(t).height() &&
						r.indexOf('bottom') > -1
					) {
						P = n;
		...
		destroy: function () {
			...
			if (n.length === 1) {
				var r =
					typeof t.Content === 'string' ? t.Content : e('<div></div>').append(t.Content).html();
				t.$el
